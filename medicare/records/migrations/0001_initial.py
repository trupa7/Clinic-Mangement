    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor', models.ForeignKey(default='none', on_delete=django.db.models.deletion.CASCADE, related_name='DO', to='employees.Doctor')),
            ],
            options={
